...
public class PlayerMovement : NetworkBehaviour
{
    ...
    private void Start()
    {
        ...
        else
        {
            ...
            cameraObjectTransform.gameObject.GetComponentInChildren<CinemachineInputProvider>().PlayerIndex = (int)NetworkManager.Singleton.LocalClientId; // Used to avoid shared camera controls.
        }
